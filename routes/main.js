module.exports = function(app, shopData) {
    ...
    app.post('/registered', function (req,res) {
        ...
        db.query(sqlquery, newrecord, (err, result) => {
          ...
          // res.send(' These details are registered to the database, username: ' req.body.username + ' firstname ' + req.body.firstname + ' lastname ' + req.body.lastname + ' email ' + req.body.email + 'hashedPassword ' + req.body.hashedPassword);
